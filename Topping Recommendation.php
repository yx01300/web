      ...
      <section class="mainContent">
        <div class="productRow">
          ...
          <article id="productInfo" class="productInfo">
            <div><button><a href="javascript:" onclick="hide1.style.display=hide1.style.display=='none'?'':'none'"><img src="https://www.milkshoptea.com/includes/timthumb.php?src=upload/product/2104061441570000001.png&w=307&zc=2" alt="sample"></a></button></div>
          ...
          <article class="productInfo">
            <div><button><a href="javascript:" onclick="hide2.style.display=hide2.style.display=='none'?'':'none'"><img alt="sample" src="https://www.milkshoptea.com/includes/timthumb.php?src=upload/product/2104081554070000001.png&w=307&zc=2"></a></button></div>
          ...
          <article class="productInfo">
            <div><button><a href="javascript:" onclick="hide3.style.display=hide3.style.display=='none'?'':'none'"><img src="https://www.milkshoptea.com/includes/timthumb.php?src=upload/product/2104081554490000001.png&w=307&zc=2" alt="sample"></a></button></div>
          ...
          <article class="productInfo">
            <div><button><a href="javascript:" onclick="hide4.style.display=hide4.style.display=='none'?'':'none'"><img alt="sample" src="https://www.milkshoptea.com/includes/timthumb.php?src=upload/product/2104081555270000001.png&w=307&zc=2"></a></button></div>
          ...
          <article class="productInfo">
            <div><button><a href="javascript:" onclick="hide5.style.display=hide5.style.display=='none'?'':'none'"><img alt="sample" src="https://www.milkshoptea.com/includes/timthumb.php?src=upload/product/2104081556130000001.png&w=307&zc=2"></a></button></div>
        ...
        <div class="productRow">
          <article class="productInfo">
            <div><button><a href="javascript:" onclick="hide6.style.display=hide6.style.display=='none'?'':'none'"><img alt="sample" src="https://www.milkshoptea.com/includes/timthumb.php?src=upload/product/2104081557230000001.png&w=307&zc=2"></a></button></div>
          ...
          <article class="productInfo">
            <div><button><a href="javascript:" onclick="hide7.style.display=hide7.style.display=='none'?'':'none'"><img alt="sample" src="https://www.milkshoptea.com/includes/timthumb.php?src=upload/product/2104081557590000001.png&w=307&zc=2"></a></button></div>
