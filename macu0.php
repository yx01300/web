      ...
      <section class="mainContent">
        <div class="productRow">
          ...
          <article class="productInfo">
            <div><button><a href="javascript:" onclick="hide1.style.display=hide1.style.display=='none'?'':'none'"><img src="http://www.maculife.com.tw/upload/product/images/202104261533341.JPG" height="125" alt="sample"></a></button></div>
          ...
          <article class="productInfo">
            <div><button><a href="javascript:" onclick="hide2.style.display=hide2.style.display=='none'?'':'none'"><img alt="sample" src="http://www.maculife.com.tw/upload/product/images/202104261536251.JPG" height="125"></a></button></div>
