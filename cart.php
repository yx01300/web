...
<body class="bg-light">
  <nav class="nav bg-white">
    <a class="nav-link active" href="http://localhost:8080/web/網設專題/frist.html">主頁</a>
    <a class="nav-link" href="http://localhost:8080/web/網設專題/Topping%20Recommendation.php">迷客夏</a>
    <a class="nav-link" href="#">coco</a>
    <a class="nav-link" href="#">麻古</a>
  </nav>
  <div class="container">
