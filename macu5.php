      ...
      <section class="mainContent">
        <div class="productRow">
          ...
          <article class="productInfo">
            <div><button><a href="javascript:" onclick="hide1.style.display=hide1.style.display=='none'?'':'none'"><img src="http://www.maculife.com.tw/upload/product/images/202005151602231.JPG" alt="sample" height="125"></a></button></div>
          ...
          <article class="productInfo">
            <div><button><a href="javascript:" onclick="hide2.style.display=hide2.style.display=='none'?'':'none'"><img alt="sample" src="http://www.maculife.com.tw/upload/product/images/202005151451561.JPG" height="125"></a></button></div>
          ...
          <article class="productInfo">
            <div><button><a href="javascript:" onclick="hide3.style.display=hide3.style.display=='none'?'':'none'"><img src="http://www.maculife.com.tw/upload/product/images/202005151603441.JPG" alt="sample" height="125"></a></button></div>
          ...
          <article class="productInfo">
            <div><button><a href="javascript:" onclick="hide4.style.display=hide4.style.display=='none'?'':'none'"><img alt="sample" src="http://www.maculife.com.tw/upload/product/images/202005151434531.JPG" height="125"></a></button></div>
          ...
          <article class="productInfo">
            <div><button><a href="javascript:" onclick="hide5.style.display=hide5.style.display=='none'?'':'none'"><img alt="sample" src="http://www.maculife.com.tw/upload/product/images/202005151453561.JPG" height="125"></a></button></div>
        ...
        <div class="productRow">
          <article class="productInfo">
            <div><button><a href="javascript:" onclick="hide6.style.display=hide6.style.display=='none'?'':'none'"><img alt="sample" src="http://www.maculife.com.tw/upload/product/images/202106171756411.JPG" height="125"></a></button></div>
          ...
          <article class="productInfo">
            <div><button><a href="javascript:" onclick="hide7.style.display=hide7.style.display=='none'?'':'none'"><img alt="sample" src="http://www.maculife.com.tw/upload/product/images/202106171757061.JPG" height="125"></a></button></div>
          ...
          <article class="productInfo">
            <div><button><a href="javascript:" onclick="hide8.style.display=hide8.style.display=='none'?'':'none'"><img alt="sample" src="http://www.maculife.com.tw/upload/product/images/202104261554101.JPG" height="125"></a></button></div>
            <span id="hide8" style="display:none">總糖量(克)/總熱量(卡):<br />L:60/767</span>
            <div style="height:15px;"></div>
            <p class="price">L:$80</p>
            <p class="productContent">布蕾搖滾波波奶茶</p>
            <input type="submit" name="button" value="Buy" class="buyButton" data-toggle="modal" data-target="#Modal5-8" style="top: -36px;"><br />
            <form method="POST">
          ...
          <article class="productInfo">
            <div><button><a href="javascript:" onclick="hide9.style.display=hide9.style.display=='none'?'':'none'"><img alt="sample" src="http://www.maculife.com.tw/upload/product/images/202106171757331.JPG" height="125"></a></button></div>
