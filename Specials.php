      ...
      <section class="mainContent">
        <div class="productRow">
          ...
          <article class="productInfo">
            <div><button><a href="javascript:" onclick="hide1.style.display=hide1.style.display=='none'?'':'none'"><img alt="sample" src="https://www.milkshoptea.com/includes/timthumb.php?src=upload/product/2104090907080000001.png&w=307&zc=2"></a></button></div>
            <span id="hide1" style="display:none">總熱量(卡)/總糖量(克)<br />L:237/40</span>
            <p class="price">$35</p>
          ...
          <article class="productInfo">
            <div><button><a href="javascript:" onclick="hide2.style.display=hide2.style.display=='none'?'':'none'"><img alt="sample" src="https://www.milkshoptea.com/includes/timthumb.php?src=upload/product/2104090909250000001.png&w=307&zc=2"></a></button></div>
            <span id="hide2" style="display:none">總熱量(卡)/總糖量(克)<br />L:238/49</span>
            <p class="price">$40</p>
          ...
          <article class="productInfo">
            <div><button><a href="javascript:" onclick="hide3.style.display=hide3.style.display=='none'?'':'none'"><img alt="sample" src="https://www.milkshoptea.com/includes/timthumb.php?src=upload/product/2104090913260000001.png&w=307&zc=2"></a></button></div>
            <span id="hide3" style="display:none">總熱量(卡)/總糖量(克)<br />L:289/65</span>
            <p class="price">$45</p>
          ...
          <article class="productInfo">
            <div><button><a href="javascript:" onclick="hide4.style.display=hide4.style.display=='none'?'':'none'"><img alt="sample" src="https://www.milkshoptea.com/includes/timthumb.php?src=upload/product/2104090914560000001.png&w=307&zc=2"></a></button></div>
            <span id="hide4" style="display:none">總熱量(卡)/總糖量(克)<br />L:199/47</span>
            <p class="price">$45</p>
          ...
          <article class="productInfo">
            <div><button><a href="javascript:" onclick="hide5.style.display=hide5.style.display=='none'?'':'none'"><img alt="sample" src="https://www.milkshoptea.com/includes/timthumb.php?src=upload/product/2104090914180000001.png&w=307&zc=2"></a></button></div>
            <span id="hide5" style="display:none">總熱量(卡)/總糖量(克)<br />L:207/51</span>
            <p class="price">$45</p>
        ...
        <div class="productRow">
          <article class="productInfo">
            <div><button><a href="javascript:" onclick="hide6.style.display=hide6.style.display=='none'?'':'none'"><img alt="sample" src="https://www.milkshoptea.com/includes/timthumb.php?src=upload/product/2104090915340000001.png&w=307&zc=2"></a></button></div>
            <span id="hide6" style="display:none">總熱量(卡)/總糖量(克)<br />L:175/36</span>
            <p class="price">$45</p>
          ...
          <article class="productInfo">
            <div><button><a href="javascript:" onclick="hide7.style.display=hide7.style.display=='none'?'':'none'"><img alt="sample" src="https://www.milkshoptea.com/includes/timthumb.php?src=upload/product/2104090916150000001.png&w=307&zc=2"></a></button></div>
            <span id="hide7" style="display:none">總熱量(卡)/總糖量(克)<br />L:204/40</span>
            <p class="price">$35</p>
          ...
          <article class="productInfo">
            <div><button><a href="javascript:" onclick="hide8.style.display=hide8.style.display=='none'?'':'none'"><img alt="sample" src="https://www.milkshoptea.com/includes/timthumb.php?src=upload/product/2104090917000000001.png&w=307&zc=2"></a></button></div>
            <span id="hide8" style="display:none">總熱量(卡)/總糖量(克)<br />L:193/39</span>
            <p class="price">$35</p>
          ...
          <article class="productInfo">
            <div><button><a href="javascript:" onclick="hide9.style.display=hide9.style.display=='none'?'':'none'"><img alt="sample" src="https://www.milkshoptea.com/includes/timthumb.php?src=upload/product/1908091315060000001.png&w=307&zc=2"></a></button></div>
            <span id="hide9" style="display:none">總熱量(卡)/總糖量(克)<br />L:268/56</span>
            <p class="price">$55</p>
          ...
          <article class="productInfo">
            <div><button><a href="javascript:" onclick="hide10.style.display=hide10.style.display=='none'?'':'none'"><img alt="sample" src="https://www.milkshoptea.com/includes/timthumb.php?src=upload/product/2104090918220000001.png&w=307&zc=2"></a></button></div>
            <span id="hide10" style="display:none">總熱量(卡)/總糖量(克)<br />L:243/53</span>
            <p class="price">$55</p>
        ...
        <div class="productRow">
          <article class="productInfo">
            <div><button><a href="javascript:" onclick="hide11.style.display=hide11.style.display=='none'?'':'none'"><img alt="sample" src="https://www.milkshoptea.com/includes/timthumb.php?src=upload/product/2104090919210000001.png&w=307&zc=2"></a></button></div>
            <span id="hide11" style="display:none">總熱量(卡)/總糖量(克)<br />L209/44</span>
            <p class="price">$60</p>
          ...
          <article class="productInfo">
            <div><button><a href="javascript:" onclick="hide12.style.display=hide12.style.display=='none'?'':'none'"><img alt="sample" src="https://www.milkshoptea.com/includes/timthumb.php?src=upload/product/2104090920230000001.png&w=307&zc=2"></a></button></div>
            <span id="hide12" style="display:none">總熱量(卡)/總糖量(克)<br />L:274/59</span>
            <p class="price">$50</p>
          ...
          <article class="productInfo">
            <div><button><a href="javascript:" onclick="hide13.style.display=hide13.style.display=='none'?'':'none'"><img alt="sample" src="https://www.milkshoptea.com/includes/timthumb.php?src=upload/product/2104090921050000001.png&w=307&zc=2"></a></button></div>
            <span id="hide13" style="display:none">總熱量(卡)/總糖量(克)<br />L:276/54</span>
            <p class="price">$50</p>
          ...
          <article class="productInfo">
            <div><button><a href="javascript:" onclick="hide14.style.display=hide14.style.display=='none'?'':'none'"><img alt="sample" src="https://www.milkshoptea.com/includes/timthumb.php?src=upload/product/1908091314530000001.png&w=307&zc=2"></a></button></div>
            <span id="hide14" style="display:none">總熱量(卡)/總糖量(克)<br />L:251/52</span>
            <p class="price">$60</p>
          ...
          <article class="productInfo">
            <div><button><a href="javascript:" onclick="hide15.style.display=hide15.style.display=='none'?'':'none'"><img src="images/28949151_88.png" alt="sample" height="157.41"></a></button></div>
            <span id="hide15" style="display:none">總熱量(卡)/總糖量(克)<br />L:256/52</span>
            <p class="price">$60</p>
        ...
        <div class="productRow">
          <article class="productInfo">
            <div><button><a href="javascript:" onclick="hide16.style.display=hide16.style.display=='none'?'':'none'"><img alt="sample" src="https://www.milkshoptea.com/includes/timthumb.php?src=upload/product/2104090923140000001.png&w=307&zc=2"></a></button></div>
            <span id="hide16" style="display:none">總熱量(卡)/總糖量(克)<br />L:236/50</span>
            <p class="price">$60</p>
